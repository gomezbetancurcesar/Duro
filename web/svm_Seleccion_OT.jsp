...
function seleccion_registro_actividadComercial(id){
    ...
    location.href='svm_Actualiza_OT.jsp?par='+id+'&correlativo='+numero+'&secuencia='+numero+"&accion="+accion;
}
        ...
        <tr>
            ...
            <td>
                ...
                if(!tipoUser.equals("Backoffice")){
                    %><input class ="botonera" type="button" name="btn_actComercial_Ingresa" value="Ingresar" onClick="window.location.href='svm_Actualiza_OT.jsp?par=1&secuencia='+<%=secu%>"/>	<%;
                }%> 
